...
import com.juyan.shortlink.project.dao.entity.LinkDeviceStatsDO;
import com.juyan.shortlink.project.dao.entity.LinkLocaleStatsDO;
import com.juyan.shortlink.project.dao.entity.LinkNetworkStatsDO;
...
import com.juyan.shortlink.project.service.ShortLinkStatsService;
...
public class ShortLinkStatsServiceImpl implements ShortLinkStatsService {
    ...
    public ShortLinkStatsRespDTO oneShortLinkStats(ShortLinkStatsReqDTO requestParam) {
        ...
        //获取List包含起始日期到结束日期之间的所有日期
        List<String> rangeDates = DateUtil.rangeToList(DateUtil.parse(requestParam.getStartDate()), DateUtil.parse(requestParam.getEndDate()), DateField.DAY_OF_MONTH).stream()
                .map(DateUtil::formatDate)
                .toList();
        //遍历rangeDates集合，将时间和返回的统计信息的时间进行比对
        //1.如果有相等的，那么就直接设置数据库里的数据作为resp
        //2.如果没有相等的，那么直接设置0作为resp
